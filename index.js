document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("scroll", function () {
    ...
    parallaxContainer.style.transform = `translateY(-${scrollY * 0.5}px)`;
    parallaxContainer1.style.transform = `translateY(-${scrollY * 0.2}px)`;
    parallaxContainer2.style.transform = `translateY(-${scrollY * 0.2}px)`;
